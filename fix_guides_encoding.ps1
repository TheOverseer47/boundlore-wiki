# ============================================
# ETAPPE 2a: Fix Guides Page Encoding (rebuild clean)
...
[System.IO.File]::WriteAllText((Join-Path (Get-Location) "wiki/guides/index.html"), $guidesHtml, $utf8NoBom)

Write-Host "Guides page rebuilt with clean UTF-8 (no BOM) encoding." -ForegroundColor Green
