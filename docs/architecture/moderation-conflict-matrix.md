...
**P4-F.2 acceptance sweep:** Draft preview planning accepted locally. No moderation workflow, queue actions, or write-path activation. Pending `add_recipe` untouched.
