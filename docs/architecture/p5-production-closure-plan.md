...
| **S-06 Search Recall** | S | **OPEN_BLOCKING** | **P5-E.9E.4H PASS** — Plan; persistenter Corpus fehlt | 4I Seed + Re-run | **P5-E.9E.4I** | Nein | Nein | Nein | Nein | Ja |
...
**P5-E.9E.4I** — Staging Persistent Canonical Corpus Seed (**STOPP** — Freigabe)
