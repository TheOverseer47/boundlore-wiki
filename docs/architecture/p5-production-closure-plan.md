...
| **S-06 Search Recall** | S | **OPEN_BLOCKING** | **P5-E.9E.4M PASS** — Staging Evidence **STAGING_CLOSED**; **P5-E.9E.5A PASS** — Cutover Plan | Final Target Decision + Production Migration + Final Closure | **P5-E.9E.5B** Read-only Legacy Inventory | Nein | Nein | Nein | Nein | Ja |
