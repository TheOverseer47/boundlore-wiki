...
| **S-06 Search Recall** | S | **OPEN_BLOCKING** | **P5-E.9E.4A PASS** — DB/FTS applied; **PARTIAL_EMPTY_CORPUS** | Client-RPC-Integration + persistenter Corpus | **Client RPC Integration** | Nein | Nein | Nein | Nein | Ja |
