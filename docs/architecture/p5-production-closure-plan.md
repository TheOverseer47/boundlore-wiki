...
| **S-06 Search Recall** | S | **OPEN_BLOCKING** | **P5-E.9E.4F PASS** — RPC_CLIENT_INTEGRATED; **PARTIAL_EMPTY_CORPUS** | Persistenter Corpus + Re-run | **Persistenter Corpus** | Nein | Nein | Nein | Nein | Ja |
