...
| **S-06 Search Recall** | S | **OPEN_BLOCKING** (Launch) | **P5-E.9E.4 Re-run PASS** — Runtime **PARTIAL** (`42501`) | Corpus-Fetch blockiert; DB/FTS offen | **Posts-Read-Fix** oder **9E.4A** | Nein | Nein | Nein | Nein | Ja |
