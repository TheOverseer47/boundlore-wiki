...
| **S-06 Search Recall** | S | **OPEN_BLOCKING** | **P5-E.9E.4I PASS** — persistenter Staging-Corpus (12 Canonicals); Recall PASS auf Staging | Production-Pfad + Re-run | **P5-E.9E.4 Re-run** / Production Migration | Nein | Nein | Nein | Nein | Ja |
