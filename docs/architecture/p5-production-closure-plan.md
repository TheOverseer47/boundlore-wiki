...
| **S-06 Search Recall** | S | **OPEN_BLOCKING** (Launch) | **P5-E.9E.4E PASS** — Runtime **PASS**; Corpus cleaned | DB/FTS + persistenter Corpus | **P5-E.9E.4A** (STOPP) | Nein | Nein | Nein | Nein | Ja |
...
**P5-E.9E.4A** — Staging Search DB Apply (**STOPP**)
