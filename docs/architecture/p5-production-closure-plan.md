...
| **S-06 Search Recall** | S | **OPEN_BLOCKING** | **P5-E.9E.5C PASS** — **LEGACY_CONDITIONAL_TARGET_CANDIDATE** | Backup + Security + Search Apply + Verification | **P5-E.9E.5D** Legacy Backup | Nein | Nein | Nein | Nein | Ja |
