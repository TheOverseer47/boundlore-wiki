...
| **S-06 Search Recall** | S | **OPEN_BLOCKING** | **P5-E.9E.5D PASS** — Legacy Backup **COMPLETE** | Security + Search Apply + Verification | **P5-E.9E.5E** Security Hardening | Nein | Nein | Nein | Nein | Ja |
