...
| **S-06 Search Recall** | S | **OPEN_BLOCKING** | **P5-E.9E.5B PASS** — Legacy Inventory **COMPLETE**; Search-Objekte fehlen | Final Target Decision + Apply + Migration | **P5-E.9E.5C** Final Target Decision | Nein | Nein | Nein | Nein | Ja |
