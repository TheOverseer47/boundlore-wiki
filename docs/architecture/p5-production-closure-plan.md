...
| **S-06 Search Recall** | S | **OPEN_BLOCKING** | **P5-E.9E.4G PASS** — RPC Runtime **PASS**; kein persistenter Corpus | Production Content + Re-run | **Production Content Migration** | Nein | Nein | Nein | Nein | Ja |
...
~~**P5-E.9E.4G**~~ **PASS** — `p5-staging-rpc-corpus-verification-report.md`
